...
import AddDisplayGreen from './AddDisplayGreen';
import AddDisplayViolet from './AddDisplayViolet';
    ...
    <div className='whiteish d-flex justify-content-center align-items-center text-center black-body'>
      <div className='black-body'>
        ...
        <AddDisplayPink
          ...
          percent={mood.acousticnessDifference.difference.toFixed(2) + '%'}
        />

        <AddDisplayWhite label={'Average Tempo'} percent={mood.tempo} />
        <AddDisplayGreen label={'You'} percent={'100%'} />
      </div>
    </div>
  );
};
